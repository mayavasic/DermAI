...
> **Note importante :** En raison des limitations de taille de GitHub, le fichier du modèle entraîné (`vgg16_finetuned_janvier.keras`) n'est pas inclus dans ce dépôt. Pour lancer l'analyse le propriétaire doit activer le Serveur Flask en local sur VSCode python app.py.
